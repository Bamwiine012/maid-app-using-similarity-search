  ...
  (self["webpackChunkv1cleaners"] = self["webpackChunkv1cleaners"] || []).push([["src_app_pages_cleanerschedules_cleanerschedules_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CleanerschedulesPageRoutingModule": function CleanerschedulesPageRoutingModule() {
          return (
            /* binding */
            _CleanerschedulesPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _cleanerschedules_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./cleanerschedules.page */
      38222);
      ...
      var _CleanerschedulesPageRoutingModule = /*#__PURE__*/_createClass(function CleanerschedulesPageRoutingModule() {
        _classCallCheck(this, CleanerschedulesPageRoutingModule);
      });

      _CleanerschedulesPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CleanerschedulesPageModule": function CleanerschedulesPageModule() {
          return (
            /* binding */
            _CleanerschedulesPageModule
          );
        }
        /* harmony export */
      ...
      var _cleanerschedules_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./cleanerschedules-routing.module */
      13546);
      /* harmony import */


      var _cleanerschedules_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./cleanerschedules.page */
      38222);

      var _CleanerschedulesPageModule = /*#__PURE__*/_createClass(function CleanerschedulesPageModule() {
        _classCallCheck(this, CleanerschedulesPageModule);
      });

      _CleanerschedulesPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _cleanerschedules_routing_module__WEBPACK_IMPORTED_MODULE_0__.CleanerschedulesPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "CleanerschedulesPage": function CleanerschedulesPage() {
          return (
            /* binding */
            _CleanerschedulesPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_cleanerschedules_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./cleanerschedules.page.html */
      87102);
      /* harmony import */


      var _cleanerschedules_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./cleanerschedules.page.scss */
      47004);
      /* harmony import */
      ...
      var _CleanerschedulesPage = /*#__PURE__*/function () {
        function CleanerschedulesPage(localService, restService, utilityService, eventsService, router, activatedRoute) {
          _classCallCheck(this, CleanerschedulesPage);
        ...
        _createClass(CleanerschedulesPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "upadateSchedule",
          value: function upadateSchedule() {
            var _this = this;

            this.utilityService.loadingOpen('Updating...');
            this.restService.postData('schedule/create', {
              start: this.start,
              end: this.end,
              day: this.day,
          ...
          value: function _delete(id) {
            ...
            this.restService.postData('schedule/delete', {
              cleaner_id: this.loggedCleaner.id,
              id: id
            }).subscribe(function (data) {
              _this2.getSchedules();
          ...
          value: function getSchedules() {
            ...
            this.restService.getData('cleaner/' + this.loggedCleaner.id + '/schedule').subscribe(function (data) {
              _this3.schedules = data;
            }, function (err) {});
          }
        }, {
          key: "changeAvailability",
          value: function changeAvailability(event) {
            var _this4 = this;
            ...
            this.restService.postData('cleaner/update_profile', {
              ...
              _this4.available = event;
            }, function (err) {});
          }
        }, {
          key: "onChangeDay",
          value: function onChangeDay() {
            this.segment = this.day;
          }
        }, {
          key: "onChangeSegment",
          value: function onChangeSegment() {
        ...
        return CleanerschedulesPage;
      }();

      _CleanerschedulesPage.ctorParameters = function () {
        return [{
      ...
      _CleanerschedulesPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_cleanerschedules_cleanerschedules_module_ts-es5.js.map