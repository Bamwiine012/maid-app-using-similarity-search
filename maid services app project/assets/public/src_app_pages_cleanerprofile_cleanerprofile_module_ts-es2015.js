...
/* harmony export */   "CleanerprofilePageRoutingModule": function() { return /* binding */ CleanerprofilePageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _cleanerprofile_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cleanerprofile.page */ 44064);
...
let CleanerprofilePageRoutingModule = class CleanerprofilePageRoutingModule {
};
CleanerprofilePageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], CleanerprofilePageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CleanerprofilePageModule": function() { return /* binding */ CleanerprofilePageModule; }
/* harmony export */ });
...
/* harmony import */ var _cleanerprofile_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cleanerprofile-routing.module */ 25070);
/* harmony import */ var _cleanerprofile_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cleanerprofile.page */ 44064);
...
let CleanerprofilePageModule = class CleanerprofilePageModule {
};
CleanerprofilePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _cleanerprofile_routing_module__WEBPACK_IMPORTED_MODULE_0__.CleanerprofilePageRoutingModule
        ],
        declarations: [_cleanerprofile_page__WEBPACK_IMPORTED_MODULE_1__.CleanerprofilePage]
    })
], CleanerprofilePageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CleanerprofilePage": function() { return /* binding */ CleanerprofilePage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_cleanerprofile_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./cleanerprofile.page.html */ 79695);
/* harmony import */ var _cleanerprofile_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cleanerprofile.page.scss */ 20036);
...
let CleanerprofilePage = class CleanerprofilePage {
    constructor(localService, restService, utilityService, eventsService, router, activatedRoute, location) {
        ...
        this.activatedRoute.queryParams.subscribe((params) => {
            if (params.id) {
                ...
                this.restService.getData('cleaner/get/' + this.id).subscribe((data) => {
                    this.cleaner = data;
                    this.utilityService.loadingClose();
                }, (err) => { });
                // get favourites
                this.restService.getData('user/get/' + this.loggedUser.id).subscribe((data) => {
                    const favourites = data.favourites;
                    if (favourites) {
                        // check for current cleaner
                        favourites.forEach((item) => {
                            if (item.cleaner_id === parseInt(this.id)) {
                                this.inFav = true;
                            }
                        });
                    }
...
CleanerprofilePage.ctorParameters = () => [
...
CleanerprofilePage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
//# sourceMappingURL=src_app_pages_cleanerprofile_cleanerprofile_module_ts-es2015.js.map