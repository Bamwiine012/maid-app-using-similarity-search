...
/* harmony import */ var _myaccount_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./myaccount.page */ 44919);
...
/* harmony import */ var _myaccount_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./myaccount-routing.module */ 60988);
/* harmony import */ var _myaccount_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myaccount.page */ 44919);
...
/* harmony import */ var _raw_loader_myaccount_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./myaccount.page.html */ 55520);
/* harmony import */ var _myaccount_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myaccount.page.scss */ 83026);
...
let MyaccountPage = class MyaccountPage {
    constructor(localService, restService, utilityService, eventsService, router, activatedRoute, actionSheetCtrl, iab, transfer, sanitizer) {
    ...
    uploadImage(userId) {
        ...
        fileTransfer
            .upload(this.lastImage.path, this.restService.baseURL + 'user/update_user_image/' + userId, options)
            .then((data) => {
    ...
    updateProfile() {
        ...
        this.restService.postData('user/update_profile', updateData).subscribe((data) => {
    ...
    updateCard() {
        const browser = this.iab.create(this.settings.STRIPE_CARD_UPDATE_URL + '/' + this.loggedUser.id, '_blank', {
            location: 'no',
            hardwareback: 'no',
        ...
        browser.on('loadstart').subscribe((e) => {
            ...
            if (e.url === this.settings.STRIPE_SUCCESS_PAYMENT_URL) {
                // update success
                browser.close();
                return this.utilityService.openAlerts('Done!', 'Payment method has been updated.', 'ok');
            }
            else if (e.url === this.settings.STRIPE_FAILED_PAYMENT_URL) {
                // payment failed
                browser.close();
                return this.utilityService.openAlerts('Oops!', 'We are unable to add this card as your payment method.', 'ok');
            }
        });
    }
};
...
//# sourceMappingURL=src_app_pages_myaccount_myaccount_module_ts-es2015.js.map