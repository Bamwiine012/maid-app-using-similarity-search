...
/* harmony export */   "CleanermoredetailsPageRoutingModule": function() { return /* binding */ CleanermoredetailsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _cleanermoredetails_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cleanermoredetails.page */ 91666);
...
let CleanermoredetailsPageRoutingModule = class CleanermoredetailsPageRoutingModule {
};
CleanermoredetailsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], CleanermoredetailsPageRoutingModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CleanermoredetailsPageModule": function() { return /* binding */ CleanermoredetailsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _cleanermoredetails_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cleanermoredetails-routing.module */ 30800);
/* harmony import */ var _cleanermoredetails_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cleanermoredetails.page */ 91666);
...
let CleanermoredetailsPageModule = class CleanermoredetailsPageModule {
};
CleanermoredetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _cleanermoredetails_routing_module__WEBPACK_IMPORTED_MODULE_0__.CleanermoredetailsPageRoutingModule
        ],
        declarations: [_cleanermoredetails_page__WEBPACK_IMPORTED_MODULE_1__.CleanermoredetailsPage]
    })
], CleanermoredetailsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CleanermoredetailsPage": function() { return /* binding */ CleanermoredetailsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_cleanermoredetails_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./cleanermoredetails.page.html */ 19621);
/* harmony import */ var _cleanermoredetails_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cleanermoredetails.page.scss */ 77534);
...
let CleanermoredetailsPage = class CleanermoredetailsPage {
    constructor(localService, restService, utilityService, eventsService, router, activatedRoute, menuCtrl, actionSheetCtrl, transfer, sanitizer, menu) {
    ...
    submitVerification() {
        ...
        this.restService
            .postData('cleaner/' + this.loggedCleaner.id + '/updatedocument', {
            ...
            this.utilityService.loadingOpen('Uploading documents...');
            this.uploadImage();
            setTimeout(() => {
            ...
            console.log(err);
            this.utilityService.openAlerts('Error!', 'Something went wrong, please try again later.', 'ok');
        });
    }
    ...
    uploadImage() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const options1 = {
                fileKey: 'image',
                fileName: `file-id-${this.loggedCleaner.id}.${this.idExt}`,
                chunkedMode: false,
                mimeType: 'multipart/form-data',
                params: {
                    fileName: `file-id-${this.loggedCleaner.id}.${this.idExt}`,
                    image: `file-id-${this.loggedCleaner.id}.${this.idExt}`,
                },
            };
            fileTransfer
                .upload(this.idImageToUpload, this.restService.baseURL +
                'cleaner/upload_cleaner_id/' +
                this.loggedCleaner.id, options1)
                .then((data) => {
                console.log(data);
                // clear the last data
                this.lastIdImage = null;
            ...
            const options2 = {
                fileKey: 'image',
                fileName: `file-address-${this.loggedCleaner.id}.${this.idExt}`,
                chunkedMode: false,
                mimeType: 'multipart/form-data',
                params: {
                    fileName: `file-address-${this.loggedCleaner.id}.${this.idExt}`,
                    image: `file-address-${this.loggedCleaner.id}.${this.idExt}`,
                },
            };
            fileTransfer
                .upload(this.addressImageToUpload, this.restService.baseURL +
                'cleaner/upload_cleaner_address/' +
                this.loggedCleaner.id, options2)
                .then((data) => {
                console.log(data);
                // clear the last data
                this.lastAddressImage = null;
...
CleanermoredetailsPage.ctorParameters = () => [
...
CleanermoredetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
//# sourceMappingURL=src_app_pages_cleanermoredetails_cleanermoredetails_module_ts-es2015.js.map