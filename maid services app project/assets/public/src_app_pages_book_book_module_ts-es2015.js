...
/* harmony export */   "BookPageRoutingModule": function() { return /* binding */ BookPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _book_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./book.page */ 87921);
...
BookPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BookPageModule": function() { return /* binding */ BookPageModule; }
/* harmony export */ });
...
/* harmony import */ var _book_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./book-routing.module */ 21214);
/* harmony import */ var _book_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./book.page */ 87921);
...
BookPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _book_routing_module__WEBPACK_IMPORTED_MODULE_0__.BookPageRoutingModule
        ],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BookPage": function() { return /* binding */ BookPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_book_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./book.page.html */ 37576);
/* harmony import */ var _book_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./book.page.scss */ 25985);
...
let BookPage = class BookPage {
    constructor(localService, restService, utilityService, eventsService, router, activatedRoute, iab) {
        ...
        if (this.localService.getSettings().hasOwnProperty('show_banner_users') &&
            this.localService.getSettings().show_banner_users === '1') {
            this.restService.getData('user/banners').subscribe((data) => {
                this.banners = data;
                if (data.length > 0) {
        ...
        this.activatedRoute.queryParams.subscribe((params) => {
            if (params.cleaner_id) {
                this.bookingdata.cleaner_id = params.cleaner_id;
            }
        });
        ...
        this.bookingdata.house_number = this.loggedUser.house_number;
    ...
    next() {
        if (!this.bookingdata.house_number ||
            this.bookingdata.house_number === '') {
        ...
        this.bookingdata.time = time[0] + ':' + time[1];
        // validate time after amount of hours
        const currentTimeString = new Date().toLocaleString('en-US', {});
        console.log(currentTimeString);
        const currentTime = new Date(currentTimeString).getTime();
        const selectedTimeString = new Date(this.bookingdata.date + 'T' + this.bookingdata.time).toLocaleString('en-US', {});
        ...
        if (selectedTime - currentTime < this.minDiffHours * 3600 * 1000) {
            return this.utilityService.openAlerts('Oops', 'The earliest you can book is ' +
                this.minDiffHours +
                ' hours before the job starts.', 'ok');
        }
...
BookPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
//# sourceMappingURL=src_app_pages_book_book_module_ts-es2015.js.map