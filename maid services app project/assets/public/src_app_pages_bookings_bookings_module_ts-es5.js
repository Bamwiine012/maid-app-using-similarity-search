  ...
  (self["webpackChunkv1cleaners"] = self["webpackChunkv1cleaners"] || []).push([["src_app_pages_bookings_bookings_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "BookingsPageRoutingModule": function BookingsPageRoutingModule() {
          return (
            /* binding */
            _BookingsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _bookings_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./bookings.page */
      50867);
      ...
      var _BookingsPageRoutingModule = /*#__PURE__*/_createClass(function BookingsPageRoutingModule() {
        _classCallCheck(this, BookingsPageRoutingModule);
      });

      _BookingsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "BookingsPageModule": function BookingsPageModule() {
          return (
            /* binding */
            _BookingsPageModule
          );
      ...
      var _bookings_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./bookings-routing.module */
      96134);
      /* harmony import */


      var _bookings_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./bookings.page */
      50867);

      var _BookingsPageModule = /*#__PURE__*/_createClass(function BookingsPageModule() {
        _classCallCheck(this, BookingsPageModule);
      });

      _BookingsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "BookingsPage": function BookingsPage() {
          return (
            /* binding */
            _BookingsPage
          );
      ...
      var _raw_loader_bookings_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./bookings.page.html */
      7006);
      /* harmony import */


      var _bookings_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./bookings.page.scss */
      94220);
      /* harmony import */
      ...
      var _BookingsPage = /*#__PURE__*/function () {
        function BookingsPage(localService, restService, utilityService, eventsService, router) {
          var _this = this;
          ...
          this.restService.getData('user/' + this.loggeduser.id + '/bookings').subscribe(function (data) {
            _this.bookings = data;

            _this.restService.getData('user/' + _this.loggeduser.id + '/pendingbookings').subscribe(function (success) {
              _this.pendingBookings = success;
        ...
        _createClass(BookingsPage, [{
          ...
          value: function doRefresh(event) {
            ...
            this.restService.getData('user/' + this.loggeduser.id + '/bookings').subscribe(function (data) {
              _this2.bookings = data;

              _this2.restService.getData('user/' + _this2.loggeduser.id + '/pendingbookings').subscribe(function (success) {
                _this2.pendingBookings = success;
      ...
      _BookingsPage.ctorParameters = function () {
        return [{
      ...
      _BookingsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_bookings_bookings_module_ts-es5.js.map